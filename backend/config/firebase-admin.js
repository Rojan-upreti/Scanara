...
// All credentials are now loaded from environment variables (configured in apphosting.yaml)
if (!process.env.FIREBASE_PRIVATE_KEY) {
  console.warn('WARNING: Firebase credentials not set in environment variables');
}
